    ...
    <ScrollView>
      <View style={styles.telas}>
        ...
        <Text style={styles.sobretext}>
          ...
          outros ativos digitais. Ele oferece uma maneira simples de acompanhar
          o desempenho de suas carteiras em tempo real, permitindo que você
          entenda seus ganhos e tome decisões informadas para maximizar seus
          retornos. Simplifique sua experiência de investimento com o Profit
          Base.
        </Text>
        <Image
        ...
        />
        <Text style={styles.sobretext}>
          Informações Autênticas e dados reais atualizados com base nos valores
          de mercado.
        </Text>
